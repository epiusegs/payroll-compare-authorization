...
export const resolver = {
  id: (parent: User) => {return parent.id},
  createdAt: (parent: User) => {return parent.createdAt},
  updatedAt: (parent: User) => {return parent.updatedAt},
  name: (parent: User) => {return parent.name},
  email: (parent: User) => {return parent.name},
  selectedClientId: (parent: User) => {return parent.name},
